                ...
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <section class="text-gray-600 body-font relative">
                            <form @submit.prevent="updateItem(customer.id)">
                                        ...
                                        <div class="flex flex-wrap -m-2">
                                            ...
                                            <div class="p-2 w-full">
                                                <div class="relative">
                                                    ...
                                                    <input type="radio" id="gender0" name="is_gender"
                                                        v-model="form.gender" value="0">
                                                    <label for="gender" class="ml-2 mr-4">男性</label>
                                                    <input type="radio" id="gender1" name="is_gender"
                                                        v-model="form.gender" value="1">
                                                    <label for="gender" class="ml-2 mr-4">女性</label>
                                                    <input type="radio" id="gender2" name="is_gender"
                                                        v-model="form.gender" value="2">
                                                    <label for="gender" class="ml-2">その他</label>
                                                </div>
                                            </div>
